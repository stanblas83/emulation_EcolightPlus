...
class State(object):
    ...
    def __init__(self,
                 ...
                 next_phase,
                 time_this_phase,
                 if_terminal,current_noise,predicted_noise,co2,fuel,waiting,lanes):
    ...
    D_TIME_THIS_PHASE = (1,)
    D_IF_TERMINAL = (1,)
    D_HISTORICAL_TRAFFIC = (60,)

    D_CO2 =(43,)   
    D_FUEL =(43,)    
    D_CURRENT_NOISE =(43,)
    D_PREDICTED_NOISE =(43,)
    D_TRAFFIC = (1,)
    D_WAITING=(43,)
...
#         print(self.path_set.PATH_TO_CONF)
